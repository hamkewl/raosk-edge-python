...
from raosk_msgsrv.msg import AbortPidsMsg	## Publish
from raosk_msgsrv.msg import MemParamsMsg, NwParamsMsg ## Subscribe (Parameters)
from raosk_msgsrv.msg import MemProcMsg, NwProcMsg	## Subscribe (Proc)
